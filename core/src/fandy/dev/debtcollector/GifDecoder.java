...
public class GifDecoder {
    ...
    public Animation<TextureRegion> getAnimation(PlayMode playMode, Boolean flipgif) {
    ...
    public static Animation<TextureRegion> loadGIFAnimation(Animation.PlayMode playMode, InputStream is,Boolean flipgif) {
        GifDecoder gdec = new GifDecoder();
        gdec.read(is);
        return gdec.getAnimation(playMode,flipgif);
    }
} 